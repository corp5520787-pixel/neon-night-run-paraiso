  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-[#090e1a] via-[#0b1120] to-[#090e1a] border border-cyan-500/20 rounded-3xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-extrabold text-white uppercase tracking-tight">
                Estado y Consumo de Base de Datos
              </h4>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Plan Gratuito Activo (100% Sin Costo)
              </span>
            </div>
            <p className="text-xs text-slate-400 mt-0.5">
              50,000 lecturas diarias gratuitas incluidas. Caché y optimizaciones activas para máximo ahorro.
            </p>
          </div>
        </div>
        ...
        <Link
          href="/admin/uso-bd"
          className="px-4 py-2.5 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition-colors whitespace-nowrap"
        >
          <Activity className="w-3.5 h-3.5 text-cyan-400" />
          <span>Ver Medidor de Uso en Tiempo Real</span>
          <ArrowUpRight className="w-3.5 h-3.5" />
        </Link>
      </div>
